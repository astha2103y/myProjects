...
public class Facebook {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(email).sendKeys("Astha@gmail.com");
		Thread.sleep(5000);
		...
		Thread.sleep(5000);
		By linktext = RelativeLocator.with(By.tagName("p")).near(By.linkText("Learn more"));
		 String ptextp = driver.findElement(linktext).getText();
		 System.out.println(ptextp);
		Thread.sleep(5000);
